...
PARAMS_FALLBACK_CSS_CLASS = dict(argnames=["objtype", "fallback_css_class"],
...
def test_add_fallback_css_class_false(doctree_css_fallback_false,
                                      objtype,
                                      fallback_css_class):
...
@pytest.mark.parametrize(**PARAMS_FALLBACK_CSS_CLASS)
def test_add_fallback_css_class_true(doctree_css_fallback_true,
                                     objtype,
                                     fallback_css_class):
